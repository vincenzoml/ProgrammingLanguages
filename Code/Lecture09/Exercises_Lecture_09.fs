...
// Aggiungere alla sintassi dei comandi il caso 
//
// CAssign2 of (ide * ide * exp * exp)
//
// Con la semantica intesa di assegnare a due variabili il risultato di due
// espressioni. Svolgere l'esercizio in due dei modi possibili: 
//
// 1) entrambe le variabili sono valutate nell'ambiente e nello stato di
